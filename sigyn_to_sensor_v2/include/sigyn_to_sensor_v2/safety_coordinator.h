...
public:
   ...
   */
    void ProcessSafetyStatus(
      uint8_t board_id, bool estop_active,
   ...
   */
    void ProcessSafetyCoordination(
      uint8_t source_board, uint8_t target_board,
