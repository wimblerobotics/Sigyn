...
alias test_teensy='cd /home/ros/sigyn_ws && colcon build --symlink-install --packages-select teensy_v2 --cmake-args -DBUILD_TESTING=ON && colcon test --packages-select teensy_v2 && colcon test-result --all'
