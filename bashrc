...
alias save_map='ros2 service call /map_saver/save_map nav2_msgs/srv/SaveMap "{map_topic: map, map_url: src/Sigyn/base/maps/mapx, image_format: pgm, map_mode: trinary, free_thresh: 0.25, occupied_thresh: 0.65}"'
