#!/usr/bin/env python3
"""
Launch file for Real Robot Step 2: Search for can with OAK-D.

This test rotates the robot until the OAK-D detector sees the can.
"""
...
def generate_launch_description():
	...
	can_do_node = Node(
		...
		parameters=[{
			...
			"groot_port": 1667,
			"bt_xml_filename": os.path.join(can_do_pkg, "bt_xml", "step2_real_search.xml"),
		}],
	)
